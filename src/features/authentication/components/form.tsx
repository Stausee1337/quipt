...
export function Form({ heading, helpInfo, children, ...props }: FormProps) {
    ...
    return (
        <BaseForm
            ...
            className="sm:bg-accent-100/10 border-accent-100/30 flex w-full flex-col gap-6 overflow-hidden border p-8 sm:mx-auto sm:w-120 sm:self-center sm:rounded-4xl"
            {...props}>
